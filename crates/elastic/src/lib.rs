...
pub use elastic_core::{
    ...
    KleeneSatisfiabilityReport, LogicError, MultiwordFactError, MultiwordFactSet,
    MultiwordFactWord, PredicateComponent, PredicateComponentError, PredicateId, PredicateKey,
    PredicateRegistry, PredicateRegistryError, PseudoBooleanBindingError, PseudoBooleanConstraint,
...
pub mod prelude {
    ...
    pub use elastic_core::{
        ...
        KleeneSatisfiabilityReport, LogicError, MultiwordFactError, MultiwordFactSet,
        MultiwordFactWord, PredicateId, PredicateKey, PredicateRegistry, PredicateRegistryError,
