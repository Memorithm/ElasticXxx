...
pub use elastic_core::{
    ...
    MultiwordGuardError, MultiwordGuardPath, PredicateComponent, PredicateComponentError,
    ...
    SymbolicBackendConfigError, SymbolicBackendResult, SymbolicResource, TransitionGuard,
    TransitionMechanism, TransitionPairAnalysis, TransitionPolicyAnalysis, TruthValue,
    WeightedPredicate, WeightedPredicateKey, BOOLEAN_EXPRESSION_SCHEMA_V1,
...
pub mod prelude {
    ...
    pub use elastic_core::{
        ...
        KleeneSatisfiabilityReport, LogicError, MultiwordBatchError, MultiwordBatchScreen,
        MultiwordCompiledGuard, MultiwordFactError, MultiwordFactSet, MultiwordFactWord,
        MultiwordGuardError, MultiwordGuardPath, PredicateId, PredicateKey, PredicateRegistry,
        ...
        PseudoBooleanScale, ResourcePolicyAnalysis, ResourcePolicyAnalysisError, TransitionGuard,
        TransitionMechanism, TransitionPairAnalysis, TransitionPolicyAnalysis, TruthValue,
        ...
        MAX_MULTIWORD_FACT_WORDS, MAX_MULTIWORD_GUARDS_PER_BATCH, MAX_PSEUDO_BOOLEAN_TERMS,
