...
pub use elastic_core::{
    ...
    RepresentationTransition, ResourcePolicyAnalysis, ResourcePolicyAnalysisError, SymbolicBackend,
    SymbolicBackendConfig, SymbolicBackendConfigError, SymbolicBackendResult, SymbolicResource,
    TransitionAttestations, TransitionGuard, TransitionMechanism, TransitionPairAnalysis,
    TransitionPolicyAnalysis, TruthValue, WeightedPredicate, WeightedPredicateKey,
    BOOLEAN_EXPRESSION_SCHEMA_V1, BOOLEAN_PREDICATE_SCHEMA_V1, DEFAULT_EXACT_ORACLE_ASSIGNMENTS,
    DEFAULT_EXACT_ORACLE_VARIABLES, DEFAULT_SYMBOLIC_MAX_CLAUSES,
    ...
    MAX_POLICY_ID_BYTES, MAX_PREDICATE_COMPONENT_BYTES, MAX_PSEUDO_BOOLEAN_TERMS,
...
pub use elastic_eir::{
    ...
    EirPseudoBooleanTerm, EirResource, EirResourceDependency, EirResourceGroup, EirSharedBudget,
    ...
    EIR_RESOURCE_GROUP_SCHEMA_VERSION, MAX_EIR_DOCUMENT_RESOURCES,
...
pub mod prelude {
    ...
    pub use elastic_core::{
        ...
        MAX_MULTIWORD_FACT_PREDICATES, MAX_MULTIWORD_FACT_WORDS, MAX_MULTIWORD_GUARDS_PER_BATCH,
        MAX_POLICY_ID_BYTES, MAX_PSEUDO_BOOLEAN_TERMS, MAX_PSEUDO_BOOLEAN_UNIT_BYTES,
    ...
    pub use elastic_eir::{
        ...
        Fingerprint, FirstGroundedPlanner, GroupLoweringError, PlanningContext,
        PolicyLoweringError, TransitionPlanner, TransitionPruningReport, ValidationError,
