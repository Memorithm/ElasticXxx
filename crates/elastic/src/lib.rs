...
pub use elastic_core::{
    ...
    KleeneSatisfiabilityReport, LogicError, MultiwordCompiledGuard, MultiwordFactError,
    MultiwordFactSet, MultiwordFactWord, MultiwordGuardError, MultiwordGuardPath,
    ...
    PseudoBooleanScale, ResourcePolicyAnalysis, ResourcePolicyAnalysisError, SymbolicBackend,
...
pub use elastic_runtime::{
    ...
    UnknownConstraintPredicateTrace, ValidatedPlan, VerificationResult,
    CONSTRAINED_DECISION_TRACE_SCHEMA_V1, DECISION_TRACE_SCHEMA_V1, GUARD_CONFIG_SCHEMA_V1,
...
pub mod prelude {
    ...
    pub use elastic_core::{
        ...
        KleeneSatisfiabilityReport, LogicError, MultiwordCompiledGuard, MultiwordFactError,
        MultiwordFactSet, MultiwordFactWord, MultiwordGuardError, MultiwordGuardPath, PredicateId,
        ...
        MAX_MULTIWORD_FACT_PREDICATES, MAX_MULTIWORD_FACT_WORDS, MAX_PSEUDO_BOOLEAN_TERMS,
        MAX_PSEUDO_BOOLEAN_UNIT_BYTES, MULTIWORD_FACT_WORD_BITS,
    };
    pub use elastic_eir::{
        evaluate_transition_guards, lower, lower_constrained, lower_guarded,
        prune_transition_candidates, ConstraintLoweringError, EirConstrainedResource, EirDocument,
