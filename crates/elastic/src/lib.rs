...
pub use elastic_adapters::{
    ...
    ModelExecutionProfileSetV1, ModelExecutionProfileSetWireV1, ModelExecutionProfileV1,
    ModelExecutionProfileWireV1, ModelExecutionResourcePlanV1, ModelExecutionResourcePlanWireV1,
