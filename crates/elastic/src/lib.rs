...
pub use elastic_adapters::{
    ...
    ModelExecutionProfilePlanV1, ModelExecutionProfilePlanWireV1,
    ModelExecutionProfilePolicyBindingError, ModelExecutionProfilePolicyBindingV1,
    ModelExecutionProfilePolicyEntryV1, ModelExecutionProfileSelectionV1,
    ...
    SoupRunResourcePlanWireV1, SoupStreamSource, Tdi93C3FactsV1, Tdi93C3PredicateV1,
    ThresholdPlanner, MODEL_EXECUTION_ACTIVATION_BUDGET_DIMENSION,
    ...
    MODEL_EXECUTION_CAPABILITIES_V1, MODEL_EXECUTION_CURRENT_PROFILE_RANK_SIGNAL,
    MODEL_EXECUTION_ENVELOPE_POLICY_MEDIA_TYPE_V1, MODEL_EXECUTION_ENVELOPE_POLICY_V1,
    MODEL_EXECUTION_EXPERT_WIDTH_DIMENSION, MODEL_EXECUTION_PROFILE_DIMENSION,
    MODEL_EXECUTION_PROFILE_PLAN_MEDIA_TYPE_V1, MODEL_EXECUTION_PROFILE_PLAN_V1,
    MODEL_EXECUTION_PROFILE_POLICY_BINDING_V1, MODEL_EXECUTION_PROFILE_PREDICATE_NAMESPACE_V1,
    ...
    SOUP_RESOURCE_PLAN_V1, SOUP_STREAM_TASKS, TDI93_C3_INTEROP_SCHEMA_V1,
...
pub use elastic_core::resource::{
    ...
    CrossResourceInvariantError, DimensionId, ImmutableCapacityReservation, Invariant,
    InvariantKind, LogicalResourceId, ObjectiveId, ObservationSignalId, ResourceClassId,
    ResourceDependency, ResourceGroup, ResourceGroupBuilder, ResourceGroupError, ResourceGroupId,
    ResourceSpec, ResourceSpecBuilder, ResourceSpecError, SafetyCapacityEnvelope,
    SafetyCapacityEnvelopeError, SafetyReservationId, SharedBudget, SharedBudgetError,
    SharedBudgetId, SharedBudgetTerm, CAPACITY_BUDGET_CONTRACT_SCHEMA_V1,
    MAX_RESOURCE_GROUP_CROSS_INVARIANTS, MAX_RESOURCE_GROUP_DEPENDENCIES,
    MAX_RESOURCE_GROUP_ID_BYTES, MAX_RESOURCE_GROUP_MEMBERS, MAX_RESOURCE_GROUP_SAFETY_ENVELOPES,
    MAX_RESOURCE_GROUP_SHARED_BUDGETS, MAX_SAFETY_RESERVATIONS_PER_ENVELOPE,
    MAX_SAFETY_RESERVATION_ID_BYTES, MAX_SHARED_BUDGET_ID_BYTES, RAM_CAPACITY_BUDGET_UNIT,
    SAFETY_CAPACITY_ENVELOPE_SCHEMA_V1, STORAGE_CAPACITY_BUDGET_UNIT,
};
pub use elastic_core::{
    ...
    ElasticDiagnosticCode, ExactBooleanOracle, ExactKleeneOracle, ExactOracleError,
    ExactOracleLimits, ExactPropertyReport, ExactPseudoBooleanOracle,
    ExactPseudoBooleanOracleError, ExactPseudoBooleanReport, ExactSatisfiabilityReport, FactMask,
    FactSet, GuardBindingError, GuardFactSource, GuardScope, GuardedResourceSpec,
    InvariantGuardDiagnostic, InvariantGuardStatus, InvariantPredicateBinding, KleeneOracleError,
    KleenePropertyReport, KleeneSatisfiabilityReport, LogicError, MultiwordBatchError,
    MultiwordBatchScreen, MultiwordCompiledGuard, MultiwordFactError, MultiwordFactSet,
    MultiwordFactWord, MultiwordGuardBatch, MultiwordGuardError, MultiwordGuardPath, PlannerHint,
    PlannerHintKey, PolicyAdvisoryError, PolicyHeader, PolicyId, PolicyIdentity,
    PolicyIdentityError, PolicyMetricScale, PolicyNumericObjective, PolicyObjectiveDirection,
    PolicyTarget, PolicyTargetKind, PolicyVersion, PredicateComponent, PredicateComponentError,
    ...
    RepresentationId, RepresentationState, RepresentationTransition, ResourcePolicyAdvisorySpec,
    ResourcePolicyAnalysis, ResourcePolicyAnalysisError, ResourcePolicyError, ResourcePolicySpec,
    SymbolicBackend, SymbolicBackendConfig, SymbolicBackendConfigError, SymbolicBackendResult,
    SymbolicResource, TransitionAttestations, TransitionGuard, TransitionMechanism,
    TransitionPairAnalysis, TransitionPolicyAnalysis, TruthValue, WeightedPredicate,
    WeightedPredicateKey, BOOLEAN_EXPRESSION_SCHEMA_V1, BOOLEAN_PREDICATE_SCHEMA_V1,
    DEFAULT_EXACT_ORACLE_ASSIGNMENTS, DEFAULT_EXACT_ORACLE_VARIABLES, DEFAULT_SYMBOLIC_MAX_CLAUSES,
    DEFAULT_SYMBOLIC_MAX_MEMORY_BYTES, DEFAULT_SYMBOLIC_MAX_NODES, DEFAULT_SYMBOLIC_SEED,
    DEFAULT_SYMBOLIC_TIMEOUT_MILLIS, ELASTIC_DIAGNOSTIC_SCHEMA_V1, FAST_PREDICATE_CAPACITY,
    ...
    MAX_MULTIWORD_GUARDS_PER_BATCH, MAX_PLANNER_HINTS, MAX_PLANNER_HINT_KEY_BYTES,
    MAX_PLANNER_HINT_VALUE_BYTES, MAX_POLICY_ID_BYTES, MAX_POLICY_METRIC_UNIT_BYTES,
    MAX_PREDICATE_COMPONENT_BYTES, MAX_PSEUDO_BOOLEAN_TERMS, MAX_PSEUDO_BOOLEAN_UNIT_BYTES,
...
pub use elastic_eir::{
    evaluate_transition_guards, lower, lower_constrained, lower_guarded, lower_resource_policy,
    lower_resource_policy_advisory, prune_transition_candidates, ConstraintLoweringError,
    EirConstrainedResource, EirCrossResourceInvariant, EirDocument, EirDocumentBuilder,
    EirGroupedDocument, EirGuard, EirGuardedResource, EirPlannerHint, EirPolicyHeader,
    EirPolicyNumericObjective, EirPredicate, EirPseudoBooleanConstraint, EirPseudoBooleanTerm,
    EirResource, EirResourceDependency, EirResourceGroup, EirResourcePolicy,
    EirResourcePolicyAdvisory, EirSharedBudget, EirSharedBudgetTerm, Fingerprint,
    FirstGroundedPlanner, GroupLoweringError, GuardedTransitionOutcome, PlanOutcome,
    PlanningContext, PolicyAdvisoryLoweringError, PolicyLoweringError, RejectedTransition,
    ResourcePolicyLoweringError, TransitionCandidate, TransitionPlanner, TransitionPruningReport,
    UnknownTransition, ValidationError, EIR_BOOLEAN_GUARD_SCHEMA_VERSION,
    EIR_POLICY_HEADER_SCHEMA_VERSION, EIR_PSEUDO_BOOLEAN_CONSTRAINT_SCHEMA_VERSION,
    EIR_RESOURCE_GROUP_SCHEMA_VERSION, EIR_RESOURCE_POLICY_ADVISORY_SCHEMA_VERSION,
    EIR_RESOURCE_POLICY_SCHEMA_VERSION, MAX_EIR_DOCUMENT_RESOURCES,
    MAX_EIR_PSEUDO_BOOLEAN_CONSTRAINTS, MAX_EIR_RESOURCE_GROUPS,
};
pub use elastic_macros::{elastic, ElasticResource};
pub use elastic_runtime::{
    abort_composite_prepare, execute_composite_transaction, linux_cpu_affinity_allowed_cpus_signal,
    linux_cpu_pressure_full_avg10_signal, linux_cpu_pressure_some_avg10_signal,
    linux_cpu_quota_cores_signal, linux_cpu_quota_unlimited_signal, prepare_composite_plan,
    retry_composite_commit_cleanup, retry_composite_prepare_cleanup,
    retry_composite_transaction_recovery, Actuation, BooleanGuardPlanner, BooleanGuardPreplanner,
    BuiltinDimensionConfigV1, BuiltinObservationSignalConfigV1, Cadence, CadenceConfig,
    CancellationToken, CandidateDecisionTrace, CapabilityPredicate, CommitRecord,
    CompositeCommitCleanupEntry, CompositeCommitCleanupEnvelope, CompositeCommitReport,
    CompositeFailureDisposition, CompositePlanEnvelope, CompositePlanError, CompositePreActState,
    CompositePrepareBackend, CompositePrepareCleanupFailure, CompositePrepareCleanupOperation,
    CompositePrepareFailure, CompositePrepareRecoveryEntry, CompositePrepareRecoveryEnvelope,
    CompositePrepareStage, CompositePreparedEnvelope, CompositePreparedSubplan,
    ...
    CompositeTransactionStage, ConcurrencyPermitsObserver, ConfiguredController,
    ConfiguredForecaster, ConfiguredPlanner, ConfiguredPlanningView, ConfiguredResource,
    ConfiguredResourceState, ConfiguredThresholdPredicateV1, ConstrainedDecisionTrace, Controller,
    ...
    ForgeWeightedPredicateV1, GuardConfigError, GuardConfigV1, GuardExprConfigV1,
    GuardPlannerTarget, GuardPreplannerError, GuardRuleConfigV1, GuardScopeConfigV1,
    GuardedPlanningDecision, GuardedPlanningOutcomeTrace, GuardedPlanningTrace, HostMemoryObserver,
    InvariantCheck, InvariantPrecheckEntry, InvariantPrecheckError, InvariantPrecheckReport,
    InvariantPrecheckStatus, InvariantPrecheckTraceSummary, LinuxCpuEnvironmentObserver,
    LinuxHwmonPowerObserver, LinuxThermalMarginObserver, LoopStopReason, LoweredGuardConfigV1,
    ...
    ValidatedPlan, VerificationResult, COMPOSITE_PLAN_ENVELOPE_SCHEMA_V1,
    COMPOSITE_PREPARE_SCHEMA_V1, COMPOSITE_TRANSACTION_SCHEMA_V1,
    CONSTRAINED_DECISION_TRACE_SCHEMA_V1, DECISION_TRACE_SCHEMA_V1, ENERGY_RATE_SOURCE_UNIT,
    FORGE_SEARCH_CANDIDATE_SCHEMA_V1, FORGE_SEARCH_PRODUCER_REPOSITORY_V1, GUARD_CONFIG_SCHEMA_V1,
    LINUX_CPU_AFFINITY_SOURCE_UNIT, LINUX_CPU_PRESSURE_SOURCE_UNIT, LINUX_CPU_QUOTA_SOURCE_UNIT,
    LINUX_CPU_QUOTA_UNLIMITED_SOURCE_UNIT, MAX_COMPOSITE_SUBPLANS, MAX_DECISION_TRACE_BYTES,
    MAX_FACTS_PER_SNAPSHOT, MAX_FACT_SOURCE_ID_BYTES, MAX_FORGE_SEARCH_CANDIDATE_BYTES,
    MAX_FORGE_SEARCH_CANDIDATE_JSON_DEPTH, MAX_GUARD_CONFIG_BYTES, MAX_GUARD_CONFIG_EXPR_NODES,
    MAX_GUARD_CONFIG_GUARDS, MAX_GUARD_CONFIG_TERM_BYTES, MAX_OPERATOR_CONFIG_BYTES,
    MAX_OPERATOR_CONFIG_JSON_DEPTH, MAX_REPRESENTATION_PRECISION_CANDIDATES,
    ...
    OPERATOR_CONFIG_VERSION, REPRESENTATION_PRECISION_FLOOR_PREDICATE_NAME,
...
pub mod prelude {
    ...
    pub use elastic_adapters::{
        ...
        ModelExecutionProfilePlanV1, ModelExecutionProfilePolicyBindingError,
        ModelExecutionProfilePolicyBindingV1, ModelExecutionProfilePolicyEntryV1,
        ModelExecutionProfileSelectionV1, ModelExecutionProfileSelectorV1,
        ModelExecutionProfileSetV1, ModelExecutionProfileV1, ModelExecutionResourcePlanV1,
        ModelExecutionResourcePlanWireV1, ModelExecutionResourceSnapshotV1, RamBudget,
        SoupAutoBatchStrategy, SoupBatchSize, SoupBatchSizeWireV1, SoupLayerStreamingV1,
        SoupLayerStreamingWireV1, SoupRunResourcePlanV1, SoupRunResourcePlanWireV1,
        SoupStreamSource, Tdi93C3FactsV1, Tdi93C3PredicateV1, ThresholdPlanner,
    ...
    pub use elastic_core::resource::{
        ...
        CrossResourceInvariantError, DimensionId, ImmutableCapacityReservation, Invariant,
        InvariantKind, LogicalResourceId, ObjectiveId, ObservationSignalId, ResourceClassId,
        ResourceDependency, ResourceGroup, ResourceGroupBuilder, ResourceGroupError,
        ResourceGroupId, ResourceSpec, ResourceSpecError, SafetyCapacityEnvelope,
        SafetyCapacityEnvelopeError, SafetyReservationId, SharedBudget, SharedBudgetError,
        SharedBudgetId, SharedBudgetTerm, CAPACITY_BUDGET_CONTRACT_SCHEMA_V1,
        MAX_RESOURCE_GROUP_CROSS_INVARIANTS, MAX_RESOURCE_GROUP_DEPENDENCIES,
        MAX_RESOURCE_GROUP_ID_BYTES, MAX_RESOURCE_GROUP_MEMBERS,
        MAX_RESOURCE_GROUP_SAFETY_ENVELOPES, MAX_RESOURCE_GROUP_SHARED_BUDGETS,
        MAX_SAFETY_RESERVATIONS_PER_ENVELOPE, MAX_SAFETY_RESERVATION_ID_BYTES,
        MAX_SHARED_BUDGET_ID_BYTES, RAM_CAPACITY_BUDGET_UNIT, SAFETY_CAPACITY_ENVELOPE_SCHEMA_V1,
        STORAGE_CAPACITY_BUDGET_UNIT,
    };
    pub use elastic_core::{
        analyze_resource_policy, BoolExpr, BooleanCpuArchitecture, BooleanCpuFeatures,
        BooleanGuard, CanonicalizationError, CompiledGuard, ElasticDiagnosticCode,
        ...
        MultiwordGuardBatch, MultiwordGuardError, MultiwordGuardPath, PlannerHint, PlannerHintKey,
        PolicyAdvisoryError, PolicyHeader, PolicyId, PolicyIdentity, PolicyIdentityError,
        PolicyMetricScale, PolicyNumericObjective, PolicyObjectiveDirection, PolicyTarget,
        PolicyTargetKind, PolicyVersion, PredicateId, PredicateKey, PredicateRegistry,
        PredicateRegistryError, PseudoBooleanBindingError, PseudoBooleanConstraint,
        PseudoBooleanConstraintDeclaration, PseudoBooleanError, PseudoBooleanRelation,
        PseudoBooleanScale, ResourcePolicyAdvisorySpec, ResourcePolicyAnalysis,
        ResourcePolicyAnalysisError, ResourcePolicyError, ResourcePolicySpec, TransitionGuard,
        TransitionMechanism, TransitionPairAnalysis, TransitionPolicyAnalysis, TruthValue,
        WeightedPredicate, WeightedPredicateKey, DEFAULT_EXACT_ORACLE_ASSIGNMENTS,
        DEFAULT_EXACT_ORACLE_VARIABLES, ELASTIC_DIAGNOSTIC_SCHEMA_V1, FAST_PREDICATE_CAPACITY,
        ...
        MAX_PLANNER_HINTS, MAX_PLANNER_HINT_KEY_BYTES, MAX_PLANNER_HINT_VALUE_BYTES,
        MAX_POLICY_ID_BYTES, MAX_POLICY_METRIC_UNIT_BYTES, MAX_PSEUDO_BOOLEAN_TERMS,
        MAX_PSEUDO_BOOLEAN_UNIT_BYTES, MAX_RESOURCE_POLICY_CONSTRAINTS, MULTIWORD_FACT_WORD_BITS,
    };
    pub use elastic_eir::{
        evaluate_transition_guards, lower, lower_constrained, lower_guarded, lower_resource_policy,
        lower_resource_policy_advisory, prune_transition_candidates, ConstraintLoweringError,
        EirConstrainedResource, EirCrossResourceInvariant, EirDocument, EirDocumentBuilder,
        EirGroupedDocument, EirGuardedResource, EirPlannerHint, EirPolicyHeader,
        EirPolicyNumericObjective, EirPseudoBooleanConstraint, EirPseudoBooleanTerm, EirResource,
        EirResourceDependency, EirResourceGroup, EirResourcePolicy, EirResourcePolicyAdvisory,
        EirSharedBudget, EirSharedBudgetTerm, Fingerprint, FirstGroundedPlanner,
        GroupLoweringError, PlanningContext, PolicyAdvisoryLoweringError, PolicyLoweringError,
        ResourcePolicyLoweringError, TransitionPlanner, TransitionPruningReport, ValidationError,
        EIR_POLICY_HEADER_SCHEMA_VERSION, EIR_RESOURCE_GROUP_SCHEMA_VERSION,
        EIR_RESOURCE_POLICY_ADVISORY_SCHEMA_VERSION, EIR_RESOURCE_POLICY_SCHEMA_VERSION,
        MAX_EIR_DOCUMENT_RESOURCES, MAX_EIR_PSEUDO_BOOLEAN_CONSTRAINTS, MAX_EIR_RESOURCE_GROUPS,
    };
    pub use elastic_macros::{elastic, ElasticResource};
    pub use elastic_runtime::{
        abort_composite_prepare, capture_constrained_decision_trace, capture_decision_trace,
        capture_guarded_planning_trace, execute_composite_transaction, fact_snapshot_fingerprint,
        ...
        linux_cpu_quota_unlimited_signal, model_execution_envelope_predicate_key,
        planning_context_fingerprint, precheck_plan_invariants, prepare_composite_plan,
        retry_composite_commit_cleanup, retry_composite_prepare_cleanup,
        retry_composite_transaction_recovery, Actuation, BooleanGuardPlanner,
        BooleanGuardPreplanner, BooleanModelExecutionProfileControllerV1,
        BooleanModelExecutionProfileEvidenceV1, BooleanModelExecutionProfileReportV1,
        BooleanThermalEnergyEvidenceV1, BooleanThermalEnergyPreplannerV1,
        BooleanThermalEnergyReportV1, BooleanThermalEnergyStatusV1, BuiltinDimensionConfigV1,
        BuiltinObservationSignalConfigV1, CadenceConfig, CancellationToken, CapabilityPredicate,
        CommitRecord, CompositeCommitCleanupEntry, CompositeCommitCleanupEnvelope,
        CompositeCommitReport, CompositeFailureDisposition, CompositePlanEnvelope,
        CompositePlanError, CompositePreActState, CompositePrepareBackend,
        CompositePrepareCleanupFailure, CompositePrepareCleanupOperation, CompositePrepareFailure,
        CompositePrepareRecoveryEntry, CompositePrepareRecoveryEnvelope, CompositePrepareStage,
        CompositePreparedEnvelope, CompositePreparedSubplan, CompositeRecoveryFailure,
        CompositeResourceCommit, CompositeTransactionBackend, CompositeTransactionFailure,
        CompositeTransactionRecoveryAction, CompositeTransactionRecoveryEntry,
        CompositeTransactionRecoveryEnvelope, CompositeTransactionStage, ConfiguredController,
        ConfiguredForecaster, ConfiguredPlanner, ConfiguredResource, ConfiguredResourceState,
        ConstrainedDecisionTrace, Controller, ControllerConfig, CurrentStateForecaster,
        CycleAttempt, CycleFailure, DecisionTrace, DecisionTraceChange, DecisionTraceChangeKind,
        DecisionTraceDiff, DecisionTraceError, DimensionConfigV1, EwmaForecaster,
        ExecutionModeConfig, FactResourceBinding, FactSnapshot, FactSourceId,
        FixedModelExecutionTransitionPolicyV1, Forecast, ForecastController, ForecastCycleAttempt,
        ForecastCycleFailure, ForecastCycleResult, ForecastRunAttempt, ForecastRunFailure,
        ...
        GuardedPlanningOutcomeTrace, GuardedPlanningTrace, HostMemoryObserver, InvariantCheck,
        InvariantPrecheckReport, InvariantPrecheckStatus, InvariantPrecheckTraceSummary,
        LinuxCpuEnvironmentObserver, LinuxHwmonPowerObserver, LinuxThermalMarginObserver,
        ...
        ModelExecutionRunEvidenceAttemptV1, ModelExecutionRunEvidenceFailureV1,
        ModelExecutionRunEvidenceResultV1, ModelExecutionTransitionModeV1,
        ModelExecutionTransitionPolicyV1, Observation, ObservationSignalConfigV1,
        ObservationSnapshot, ObservationSource, Observer, ObserverSet, OperatorConfig, Plan,
        PlannerSelection, PlanningContextFingerprint, PredicateConfigV1, PredicateEvaluationInput,
        PredicateEvaluator, PredicateKeyConfigV1, PseudoBooleanConstraintTermTrace,
        PseudoBooleanConstraintTrace, RamBudgetObserver, RegisteredResource, ResourceConfig,
        ResourceRegistry, RollbackRecord, Runtime, RuntimeConfig, RuntimeError, RuntimeMode,
        ThresholdComparison, ThresholdComparisonConfigV1, TransactionalActuator,
        TransactionalConcurrency, TransactionalModelExecution, TransactionalRam,
        TransitionGuardedModelExecutionBackendError, TransitionGuardedModelExecutionBackendV1,
        TransitionMechanismConfigV1, ValidatedPlan, VerificationResult,
        COMPOSITE_PLAN_ENVELOPE_SCHEMA_V1, COMPOSITE_PREPARE_SCHEMA_V1,
        COMPOSITE_TRANSACTION_SCHEMA_V1, CONSTRAINED_DECISION_TRACE_SCHEMA_V1,
        DECISION_TRACE_SCHEMA_V1, ENERGY_RATE_SOURCE_UNIT,
        ENERGY_RATE_WITHIN_BUDGET_PREDICATE_NAME, GUARD_CONFIG_SCHEMA_V1,
        LINUX_CPU_AFFINITY_SOURCE_UNIT, LINUX_CPU_PRESSURE_SOURCE_UNIT,
        LINUX_CPU_QUOTA_SOURCE_UNIT, LINUX_CPU_QUOTA_UNLIMITED_SOURCE_UNIT, MAX_COMPOSITE_SUBPLANS,
        MAX_MODEL_EXECUTION_CONTROLLER_CONTRACTS_BYTES,
        MAX_MODEL_EXECUTION_CONTROLLER_CONTRACTS_JSON_DEPTH, MODEL_EXECUTION_CONTROLLER_CONTRACTS_V1,
        MODEL_EXECUTION_CYCLE_EVIDENCE_V1, MODEL_EXECUTION_ENVELOPE_PREDICATE_NAME,
        MODEL_EXECUTION_ENVELOPE_PREDICATE_NAMESPACE,
        OPERATOR_CONFIG_VERSION, THERMAL_ENERGY_MAX_AGE, THERMAL_ENERGY_PREDICATE_NAMESPACE,
        THERMAL_MARGIN_SOURCE_UNIT, THERMAL_MARGIN_SUFFICIENT_PREDICATE_NAME,
    };
    pub use elastic_runtime::{
