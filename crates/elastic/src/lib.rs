...
pub use elastic_core::{
    ...
    PredicateId, PredicateKey, PredicateRegistry, PredicateRegistryError, PseudoBooleanConstraint,
    ...
    WeightedPredicate, BOOLEAN_EXPRESSION_SCHEMA_V1, BOOLEAN_PREDICATE_SCHEMA_V1,
...
pub mod prelude {
    ...
    pub use elastic_core::{
        ...
        PredicateRegistryError, PseudoBooleanConstraint, PseudoBooleanError, PseudoBooleanRelation,
        PseudoBooleanScale, ResourcePolicyAnalysis, ResourcePolicyAnalysisError, TransitionGuard,
        TransitionMechanism, TransitionPairAnalysis, TransitionPolicyAnalysis, TruthValue,
        WeightedPredicate, DEFAULT_EXACT_ORACLE_ASSIGNMENTS, DEFAULT_EXACT_ORACLE_VARIABLES,
        FAST_PREDICATE_CAPACITY, MAX_BOOLEAN_EXPR_DEPTH, MAX_EXACT_ORACLE_ASSIGNMENTS,
        MAX_EXACT_ORACLE_VARIABLES, MAX_PSEUDO_BOOLEAN_TERMS, MAX_PSEUDO_BOOLEAN_UNIT_BYTES,
    };
    pub use elastic_eir::{
        evaluate_transition_guards, lower, lower_guarded, prune_transition_candidates, EirDocument,
