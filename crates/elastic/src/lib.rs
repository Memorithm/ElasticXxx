...
pub use elastic_runtime::{
    abort_composite_prepare, prepare_composite_plan, Actuation, BooleanGuardPlanner,
    BooleanGuardPreplanner, BuiltinDimensionConfigV1, BuiltinObservationSignalConfigV1, Cadence,
    CadenceConfig, CancellationToken, CandidateDecisionTrace, CapabilityPredicate, CommitRecord,
    CompositePlanEnvelope, CompositePlanError, CompositePreActState, CompositePrepareBackend,
    ...
    ConfiguredPlanningView, ConfiguredResource, ConfiguredResourceState,
    ConfiguredThresholdPredicateV1, ConstrainedDecisionTrace, Controller, ControllerConfig,
    ...
    DecisionTraceDiff, DecisionTraceError, DimensionConfigV1, EwmaForecaster, ExecutionModeConfig,
    ...
    Forecaster, ForecasterSelection, ForgeCandidateSourceV1, ForgePseudoBooleanConstraintV1,
    ForgePseudoBooleanRelationV1, ForgeRevalidatedPolicyV1, ForgeSearchCandidateError,
    ForgeSearchCandidateV1, ForgeWeightedPredicateV1, GuardConfigError, GuardConfigV1,
    GuardExprConfigV1, GuardPlannerTarget, GuardPreplannerError, GuardRuleConfigV1,
    GuardScopeConfigV1, GuardedPlanningDecision, GuardedPlanningOutcomeTrace, GuardedPlanningTrace,
    HostMemoryObserver, InvariantCheck, InvariantPrecheckEntry, InvariantPrecheckError,
    ...
    COMPOSITE_PREPARE_SCHEMA_V1, CONSTRAINED_DECISION_TRACE_SCHEMA_V1, DECISION_TRACE_SCHEMA_V1,
    ENERGY_RATE_SOURCE_UNIT, FORGE_SEARCH_CANDIDATE_SCHEMA_V1, FORGE_SEARCH_PRODUCER_REPOSITORY_V1,
    GUARD_CONFIG_SCHEMA_V1, MAX_COMPOSITE_SUBPLANS, MAX_DECISION_TRACE_BYTES,
...
pub mod prelude {
    ...
    pub use elastic_runtime::{
        ...
        capture_guarded_planning_trace, fact_snapshot_fingerprint,
        model_execution_envelope_predicate_key, planning_context_fingerprint,
        precheck_plan_invariants, prepare_composite_plan, retry_composite_prepare_cleanup,
        Actuation, BooleanGuardPlanner, BooleanGuardPreplanner,
        BooleanModelExecutionProfileControllerV1, BooleanModelExecutionProfileEvidenceV1,
        BooleanModelExecutionProfileReportV1, BooleanThermalEnergyEvidenceV1,
        BooleanThermalEnergyPreplannerV1, BooleanThermalEnergyReportV1,
        BooleanThermalEnergyStatusV1, BuiltinDimensionConfigV1, BuiltinObservationSignalConfigV1,
        CadenceConfig, CancellationToken, CapabilityPredicate, CommitRecord, CompositePlanEnvelope,
