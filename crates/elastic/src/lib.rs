...
pub use elastic_adapters::{
    ...
    ModelExecutionContractError, ModelExecutionProfileEnvelopeV1, ModelExecutionProfileError,
    ...
    ModelExecutionResourcePlanWireV1, PlannerConfigError, RamBudget, SoupAutoBatchStrategy,
    ...
    MODEL_EXECUTION_ACTIVE_EXPERTS_DIMENSION, MODEL_EXECUTION_BASIS_POINTS_FULL,
    MODEL_EXECUTION_CAPABILITIES_MEDIA_TYPE_V1, MODEL_EXECUTION_CAPABILITIES_V1,
    MODEL_EXECUTION_EXPERT_WIDTH_DIMENSION, MODEL_EXECUTION_PROFILE_PLAN_MEDIA_TYPE_V1,
...
pub mod prelude {
    pub use elastic_adapters::{
        ...
        ModelExecutionCapabilitiesWireV1, ModelExecutionProfileEnvelopeV1,
        ...
        ModelExecutionResourcePlanV1, ModelExecutionResourcePlanWireV1, RamBudget,
