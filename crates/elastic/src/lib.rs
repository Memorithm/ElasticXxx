...
pub use elastic_core::{
    ...
    MultiwordGuardBatch, MultiwordGuardError, MultiwordGuardPath, PolicyHeader, PolicyId,
    PolicyIdentity, PolicyIdentityError, PolicyTarget, PolicyTargetKind, PolicyVersion,
    PredicateComponent, PredicateComponentError, PredicateId, PredicateKey, PredicateRegistry,
    ...
    PseudoBooleanScale, RepresentationEpoch, RepresentationId, RepresentationState,
    RepresentationTransition, ResourcePolicyAnalysis, ResourcePolicyAnalysisError,
    ResourcePolicyError, ResourcePolicySpec, SymbolicBackend, SymbolicBackendConfig,
    ...
    MAX_MULTIWORD_GUARDS_PER_BATCH, MAX_POLICY_ID_BYTES, MAX_PREDICATE_COMPONENT_BYTES,
...
pub use elastic_eir::{
    ...
    EirGuardedResource, EirPolicyHeader, EirPredicate, EirPseudoBooleanConstraint,
    EirPseudoBooleanTerm, EirResource, EirResourceDependency, EirResourceGroup, EirResourcePolicy,
    EirSharedBudget, EirSharedBudgetTerm, Fingerprint, FirstGroundedPlanner, GroupLoweringError,
    GuardedTransitionOutcome, PlanOutcome, PlanningContext, PolicyLoweringError,
    RejectedTransition, ResourcePolicyLoweringError, TransitionCandidate, TransitionPlanner,
    ...
    EIR_RESOURCE_GROUP_SCHEMA_VERSION, EIR_RESOURCE_POLICY_SCHEMA_VERSION,
...
pub mod prelude {
    ...
    pub use elastic_core::{
        ...
        MultiwordGuardPath, PolicyHeader, PolicyId, PolicyIdentity, PolicyIdentityError,
        PolicyTarget, PolicyTargetKind, PolicyVersion, PredicateId, PredicateKey,
        PredicateRegistry, PredicateRegistryError, PseudoBooleanBindingError,
        PseudoBooleanConstraint, PseudoBooleanConstraintDeclaration, PseudoBooleanError,
        PseudoBooleanRelation, PseudoBooleanScale, ResourcePolicyAnalysis,
        ...
        DEFAULT_EXACT_ORACLE_VARIABLES, FAST_PREDICATE_CAPACITY, MAX_BOOLEAN_EXPR_DEPTH,
        MAX_EXACT_ORACLE_ASSIGNMENTS, MAX_EXACT_ORACLE_VARIABLES, MAX_MULTIWORD_FACT_PREDICATES,
        MAX_MULTIWORD_FACT_WORDS, MAX_MULTIWORD_GUARDS_PER_BATCH, MAX_POLICY_ID_BYTES,
        MAX_PSEUDO_BOOLEAN_TERMS, MAX_PSEUDO_BOOLEAN_UNIT_BYTES, MAX_RESOURCE_POLICY_CONSTRAINTS,
    ...
    pub use elastic_eir::{
        ...
        EirGuardedResource, EirPolicyHeader, EirPseudoBooleanConstraint, EirPseudoBooleanTerm,
        EirResource, EirResourceDependency, EirResourceGroup, EirResourcePolicy, EirSharedBudget,
        EirSharedBudgetTerm, Fingerprint, FirstGroundedPlanner, GroupLoweringError,
        PlanningContext, PolicyLoweringError, ResourcePolicyLoweringError, TransitionPlanner,
        TransitionPruningReport, ValidationError, EIR_POLICY_HEADER_SCHEMA_VERSION,
        EIR_RESOURCE_GROUP_SCHEMA_VERSION, EIR_RESOURCE_POLICY_SCHEMA_VERSION,
        MAX_EIR_DOCUMENT_RESOURCES, MAX_EIR_PSEUDO_BOOLEAN_CONSTRAINTS, MAX_EIR_RESOURCE_GROUPS,
    };
    pub use elastic_macros::{elastic, ElasticResource};
