...
pub use elastic_runtime::{
    abort_composite_prepare, execute_composite_transaction, prepare_composite_plan,
    ...
    InvariantPrecheckStatus, InvariantPrecheckTraceSummary, LinuxHwmonPowerObserver,
    LinuxThermalMarginObserver, LoopStopReason, LoweredGuardConfigV1,
    ...
    MAX_COMPOSITE_SUBPLANS, MAX_DECISION_TRACE_BYTES, MAX_FACTS_PER_SNAPSHOT,
    MAX_FACT_SOURCE_ID_BYTES, MAX_FORGE_SEARCH_CANDIDATE_BYTES,
...
pub mod prelude {
    ...
    pub use elastic_runtime::{
        ...
        model_execution_envelope_predicate_key, planning_context_fingerprint,
        precheck_plan_invariants, prepare_composite_plan, retry_composite_commit_cleanup,
        retry_composite_prepare_cleanup, retry_composite_transaction_recovery, Actuation,
        BooleanGuardPlanner, BooleanGuardPreplanner, BooleanModelExecutionProfileControllerV1,
        BooleanModelExecutionProfileEvidenceV1, BooleanModelExecutionProfileReportV1,
        ...
        LinuxHwmonPowerObserver, LinuxThermalMarginObserver, ModelExecutionControllerContractsV1,
        ModelExecutionControllerContractsWireV1, ModelExecutionControllerV1,
        ModelExecutionCycleEvidenceV1, ModelExecutionObserverBundleV1,
        ModelExecutionProfileBackendV1, ModelExecutionResourceObserverV1,
        ModelExecutionResourceTelemetrySampleV1, ModelExecutionResourceTelemetryV1,
        ...
        ENERGY_RATE_WITHIN_BUDGET_PREDICATE_NAME, GUARD_CONFIG_SCHEMA_V1, MAX_COMPOSITE_SUBPLANS,
