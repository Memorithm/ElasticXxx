...
pub use elastic_core::{
    ...
    PolicyTargetKind, PolicyVersion, PredicateComponent, PredicateComponentError, PredicateId,
    PredicateKey, PredicateRegistry, PredicateRegistryError, PseudoBooleanBindingError,
    PseudoBooleanConstraint, PseudoBooleanConstraintDeclaration, PseudoBooleanError,
    PseudoBooleanRelation, PseudoBooleanScale, RepresentationEpoch, RepresentationId,
    RepresentationState, RepresentationTransition, ResourcePolicyAdvisorySpec,
    ...
    DEFAULT_SYMBOLIC_TIMEOUT_MILLIS, FAST_PREDICATE_CAPACITY, MAX_BOOLEAN_EXPR_DEPTH,
    MAX_CANONICAL_EXPRESSION_NODES, MAX_EXACT_ORACLE_ASSIGNMENTS, MAX_EXACT_ORACLE_VARIABLES,
    ...
    MAX_POLICY_ID_BYTES, MAX_POLICY_METRIC_UNIT_BYTES, MAX_PREDICATE_COMPONENT_BYTES,
    MAX_PSEUDO_BOOLEAN_TERMS, MAX_PSEUDO_BOOLEAN_UNIT_BYTES, MAX_REGISTERED_PREDICATES,
...
pub mod prelude {
    ...
    pub use elastic_core::{
        ...
        MultiwordGuardPath, PlannerHint, PlannerHintKey, PolicyAdvisoryError, PolicyHeader,
        PolicyId, PolicyIdentity, PolicyIdentityError, PolicyMetricScale, PolicyNumericObjective,
        PolicyObjectiveDirection, PolicyTarget, PolicyTargetKind, PolicyVersion, PredicateId,
        PredicateKey, PredicateRegistry, PredicateRegistryError, PseudoBooleanBindingError,
        PseudoBooleanConstraint, PseudoBooleanConstraintDeclaration, PseudoBooleanError,
        PseudoBooleanRelation, PseudoBooleanScale, ResourcePolicyAdvisorySpec,
        ResourcePolicyAnalysis, ResourcePolicyAnalysisError, ResourcePolicyError,
        ResourcePolicySpec, TransitionGuard, TransitionMechanism, TransitionPairAnalysis,
