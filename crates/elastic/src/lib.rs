...
pub use elastic_runtime::{
    ...
    GUARDED_PLANNING_CAPTURE_SCHEMA_V1, MAX_EVIDENCE_BYTES, MAX_EVIDENCE_COLLECTION_ITEMS,
    MAX_EVIDENCE_DEPTH, MAX_EVIDENCE_DIFF_PATHS, MAX_EVIDENCE_NODES,
...
pub use elastic_runtime::{
    ...
    GuardedPlanningCapture, GuardedPlanningDecision, GuardedPlanningOutcomeKind,
    GuardedPlanningTraceError, HostMemoryObserver, InvariantCheck, InvariantPrecheckEntry,
    InvariantPrecheckError, InvariantPrecheckReport, InvariantPrecheckStatus,
    InvariantPrecheckTraceSummary, LoopStopReason, ModelExecutionActuationEvidenceV1,
    ...
    PredicateEvaluator, PredicateTraceEntry, PruningReportFingerprint, RamBudgetObserver,
...
pub mod prelude {
    ...
    pub use elastic_runtime::{
        ...
        DecisionTraceChangeKind, DecisionTraceDiff, DecisionTraceError, EwmaForecaster,
