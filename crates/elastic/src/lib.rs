...
pub use elastic_core::{
    ...
    MAX_EXACT_ORACLE_VARIABLES, MAX_PREDICATE_COMPONENT_BYTES, MAX_PSEUDO_BOOLEAN_TERMS,
...
pub mod prelude {
    ...
    pub use elastic_core::{
        ...
        MAX_EXACT_ORACLE_ASSIGNMENTS, MAX_EXACT_ORACLE_VARIABLES, MAX_PSEUDO_BOOLEAN_TERMS,
