...
pub use elastic_core::{
    ...
    BooleanCpuFeatures, BooleanGuard, CanonicalizationError, CompiledGuard, ExactBooleanOracle,
    ...
    GuardedResourceSpec, InvariantGuardDiagnostic, InvariantGuardStatus, InvariantPredicateBinding,
    ...
    MultiwordGuardPath, PredicateComponent, PredicateComponentError, PredicateId, PredicateKey,
