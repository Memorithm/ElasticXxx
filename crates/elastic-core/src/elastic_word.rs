//! Elastic multi-lane word representation for adaptive control-plane metadata.
//!
...
//! Resource/domain adapters remain responsible for proving that a width transition
//! preserves their semantic invariants.

use crate::TransitionMechanism;
use std::fmt;
