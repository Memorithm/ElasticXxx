...
- collector-derived codegen profile: `native`;
...
- continuous CPUFreq samples: 3111; stability check: true;
...
- preregistered timing-stability gate: **true** (worst block-median spread ratio: 0.019796140; limit: 0.10);
