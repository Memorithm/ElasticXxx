...
Source: `468eb52f646cae0e70a7342cd9b7374ddb01ef15` on `NVIDIA Jetson AGX Thor Developer Kit` with Rust 1.89.0.
...
- continuous CPUFreq samples: 3682; stability check: true;
...
- preregistered timing-stability gate: **true** (worst block-median spread ratio: 0.069218180; limit: 0.10);
