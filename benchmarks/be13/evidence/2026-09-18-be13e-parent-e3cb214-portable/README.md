...
Source: `e3cb2141260dce36495db4b736d2654d4eac959f` on `NVIDIA Jetson AGX Thor Developer Kit` with Rust 1.89.0.
...
- continuous CPUFreq samples: 3749; stability check: true;
...
- preregistered timing-stability gate: **true** (worst block-median spread ratio: 0.072670099; limit: 0.10);
